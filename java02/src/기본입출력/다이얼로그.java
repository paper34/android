...
public class 다이얼로그 {
	...
	public static void main(String[] args) {
		...
		// 자바에서는 자주 사용되는 부품은
		// 미리 메모리에 가져다놓고 있음.
		// 부품의 이름을 대문자로 사용하면 된다.
		String hour = JOptionPane.showInputDialog("지금몇시인가요?"); // 입력
		JOptionPane.showMessageDialog(null, hour + "시입니다."); // 출력
		// empty == null
		...
		if (hour2 < 16) { // 조건에는 비교연산자를 쓰고, 비교연산자의 결과는 논리!
			// true
			JOptionPane.showMessageDialog(null, "아직 집에 갈 시간이 멀었구요");
		} else { // false
