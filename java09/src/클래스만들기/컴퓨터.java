...
public class 컴퓨터 {
	...
	// 객체 생성 후, 멤버변수는 객체마다 다 별도로 복사하게 된다.
	...
	public int size; // 모니터의 크기 public 접근 제어자

	// 동작정의 => 멤버메서드
	// 접근제저아 (default, public)
	...
	// 원래 toString()는 기초형이지만 기초형값, 참조형이면 주소를 찍어주는 값
	// toString()를 내가 원하는 프린트모양대로 변경해서 사용할 수잇다.
