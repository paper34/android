					...
					<form name="form" id="form" role="form" method="post"
						...
						<div class="mb-3">
							<input type="hidden" class="form-control" name="writer"
									id="writer" value="<%=session.getAttribute("id") %>" placeholder="이름을 입력해 주세요"> 
						</div>
						...
						<div>
							<button type="submit" class="btn btn btn-dark" id="btnSave" onclick="check()">저장</button>
							<a href="main-bbs.jsp">
								<button type="button" class="btn btn btn-dark" id="btnList">취소</button>
							</a>
						</div>
					</form>
				</div>
