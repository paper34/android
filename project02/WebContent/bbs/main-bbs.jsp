	...
	<div class="row">
		...
		<div class="column middle">
			...
			<table class="table table-hover text-center" id="click">
				...
				<tbody style="font-size: 15px">
					...
					<tr class='clickable-row'data-href='./read-bbs.jsp?no=<%=list.get(i).getNo()%>'>
						...
						class="no"value="<%=list.get(i).getNo()%>"><%=list.get(i).getNo()%>
						</th>
			...
			%>
			  ...
			  <button type="button" onclick="location.href='write-bbs.jsp'"
			  class="btn btn-dark content-right"style="display: none">글쓰기</button>
